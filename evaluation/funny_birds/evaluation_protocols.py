...
from data import FunnyBirdsDataset
...
def accuracy_protocol(model, data_path, batch_size):
    ...
    transforms = None
    test_dataset = FunnyBirdsDataset(data_path, "test", transform=transforms, eval_funny_birds=True)
...
def controlled_synthetic_data_check_protocol(model, explainer, data_path, nr_itrs=2501):
    transforms = None
    test_dataset = FunnyBirdsDataset(data_path, "test", get_part_map=True, transform=transforms, eval_funny_birds=True)
