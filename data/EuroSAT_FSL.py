...
class EuroSAT_DataLoader(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.train_dataset = EuroSATDataset(root_dir='/ ', transform=train_transform, N=self.n_way, K=self.k_shot, Q=self.q_query, is_train=True) 
        self.test_dataset = EuroSATDataset(root_dir='/ ', transform=test_transform, N=self.n_way, K=self.k_shot, Q=self.q_query, is_train=False) 
...
if __name__ == '__main__':
    ...
    train_dataset = EuroSATDataset(root_dir, transform=train_transform, N=5, K=5, Q=15, is_train=True)
    print(train_dataset.class_names)
  
    loader = EuroSAT_DataLoader(data_dir=' ', n_way=5, k_shot=5, q_query=15, n_iter=10, transform=train_transform)
    loader.setup()
