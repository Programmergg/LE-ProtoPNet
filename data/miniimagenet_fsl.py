...
class miniimagenet_DataLoader(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.train_dataset = miniimagenetDataset(root_dir=' ', transform=train_transform, N=self.n_way, K=self.k_shot, Q=self.q_query, is_train=True) 
 
        self.test_dataset = miniimagenetDataset(root_dir=' ', transform=test_transform, N=self.n_way, K=self.k_shot, Q=self.q_query, is_train=False) 
...
#    print(train_dataset.class_names)
   # print(train_dataset.img_paths)
    loader = miniimagenet_DataLoader(data_dir=' ', n_way=5, k_shot=1, q_query=15, n_iter=10, transform=train_transform)
    loader.setup()
    train_dataset = loader.train_dataloader()
    test_dataset = loader.test_dataloader
